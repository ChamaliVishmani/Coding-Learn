...
def merge_sort(linked_list: LinkedList):
    ...
    - repeatedly merge the sub lists to produce sub lists until one remains
...
def split(linked_list: LinkedList):
    ...
    if linked_list is None or linked_list.head is None:
        ...
        mid_node.next_node = None  # make mid-node tail node of left_half
...
def merge(left, right):
    ...
    while left_head or right_head:
        ...
        if left_head is None:
            ...
            # Call next on right to set loop condition to False (then right_head will be None)
